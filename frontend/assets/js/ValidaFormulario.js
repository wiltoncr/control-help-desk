export default class ValidaFormulario {
    ...
    senhasSaoValidas() {
      ...
      const senha = this.form.querySelector("input[name='password']");
      //const repetirSenha = this.formulario.querySelector('.repetir-senha');
  
      if(!senha.value /*!== repetirSenha.value*/) {
        valid = false;
        this.criaErro(senha, 'Campos senha  senha precisar está preechida.');
    ...
    camposSaoValidos() {
      let valid = true;
      /*removendo mensagens de erro na tela */
